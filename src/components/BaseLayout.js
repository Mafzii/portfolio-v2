...
export default function BaseLayout({ children, additional }) {
    return (
        <>
            ...
            <div className="relative w-screen h-screen flex flex-col sm:justify-center items-center bg-neutral-950/95 text-gray-100">
                <header className="z-10 top-0 left-0 w-screen flex justify-between items-center box-border h-[20vh] max-h-[20vh] sm:max-h-full p-6 sm:p-10">
                    <div className="flex items-center gap-2">
                        <Link href="/" passHref>
                            <div className="w-14 h-14 rounded-full bg-neutral-800/90 flex items-center justify-center shadow-md cursor-pointer overflow-hidden ring-1 ring-white/8">
                                <Image
                        ...
                        <div className="flex flex-col items-center gap-2">
                            <a href="https://github.com/Mafzii" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-neutral-800/90 rounded-full shadow ring-1 ring-white/8 hover:bg-neutral-500 transition-colors">
                                {/* GitHub filled icon */}
                            ...
                            <a href="https://www.linkedin.com/in/mustafa-afzal/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-neutral-800/90 rounded-full shadow ring-1 ring-white/8 hover:bg-neutral-500 transition-colors">
                                {/* LinkedIn icon */}
                    ...
                    <div className="flex gap-4">
                        <Link href="/projects">
                            <div className="type-nav bg-neutral-800/90 rounded-full px-5 py-2.5 text-[1.15rem] shadow-md ring-1 ring-white/8 transition-colors duration-200 hover:bg-neutral-500 hover:text-white">Projects</div>
                        </Link>
                        <Link href="/blog">
                            <div className="type-nav bg-neutral-800/90 rounded-full px-5 py-2.5 text-[1.15rem] shadow-md ring-1 ring-white/8 transition-colors duration-200 hover:bg-neutral-500 hover:text-white">Blog</div>
                        </Link>
                    </div>
                </header>
